...
//            let lastFajr = calendar.dateComponents([.hour, .minute], from:  changeStringToTime(timeString: waktuSholat.fajr))
...
//            let lastSunrise = calendar.dateComponents([.hour, .minute], from:  changeStringToTime(timeString: waktuSholat.sunrise))
...
//            let lastDhuhr = calendar.dateComponents([.hour, .minute], from:  changeStringToTime(timeString: waktuSholat.dhuhr))
...
//            let lastAsr = calendar.dateComponents([.hour, .minute], from:  changeStringToTime(timeString: waktuSholat.asr))
...
//            let lastMaghrib = calendar.dateComponents([.hour, .minute], from:  changeStringToTime(timeString: waktuSholat.maghrib))
